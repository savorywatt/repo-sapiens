...
```python
from repo_sapiens.git import GitUrlParser
...
```python
from repo_sapiens.git import detect_git_origin
...
```python
from repo_sapiens.git import GitDiscovery, MultipleRemotesError
...
```python
from repo_sapiens.git import GitDiscovery, GitDiscoveryError
...
# With coverage
pytest tests/git/ --cov=repo_sapiens.git --cov-report=term-missing
```
