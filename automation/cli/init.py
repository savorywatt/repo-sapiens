...
from automation.credentials import CredentialResolver, EnvironmentBackend, KeyringBackend
...
class RepoInitializer:
    ...
    def _configure_ai_agent(self) -> None:
        ...
        from automation.utils.agent_detector import detect_available_agents, format_agent_list
